...
let URL = "https://teachablemachine.withgoogle.com/models/bpPb5ikpI/";
    ...
    if (prob > 0.8 && !explosionActive) {
        ...
        switch(poseNumber) {
            case '1':
                ...
                break;
            case '2':
                if (time >= 10.0 && time <= 12.0 && !poseState.triggered) {
                    triggerExplosion(poseState);
                }
                break;
            case '3':
             if (time >= 13.0 && time <= 15.0 && !poseState.triggered) {
                    triggerExplosion(poseState);
                }
                break;
            case '4':
...
async function playInstructionVideo() {
    ...
    if (model) {
        ...
        console.log("https://teachablemachine.withgoogle.com/models/bpPb5ikpI/");
    }
}
